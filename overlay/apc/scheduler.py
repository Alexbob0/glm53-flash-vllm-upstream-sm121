...
class Scheduler(SchedulerInterface):
    def __init__(
        ...
        # [apc-align] real mamba block size for chunk alignment (cache_config.block_size
    ...
    def _mamba_block_aligned_split(
        ...
        # [apc-align] align on the mamba group block (may exceed cache_config.block_size)
